  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="border-bottom mb-4">{envsList}</div>
      </div>
    );
  }
}
  ...
  render() {
    ...
    return (
      <div>
        <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-4 border-bottom">
          ...
          <div className="btn-toolbar mb-2 mb-md-0">
            <div className="btn-group mr-2">
              <button
                type="button"
                className="btn btn-outline-danger tableAction-button"
        ...
        <p>
          Deleting a package is a permanent action and all data not stored in
  ...
  render() {
    return (
      <div>
        ...
        <p>
          Deleting this package volumes is a permanent action and all data will
          be lost. In the case of the ethcahin core package, resyncing may take
          a few days
        </p>
      </div>
    );
...
class PackageHeader extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-4 border-bottom">
          <h1 className="h2">{capitalize(this.props.displayName)} settings</h1>
          <div className="btn-toolbar mb-2 mb-md-0">
            <div className="btn-group mr-2">
              {pauseButton}
              <button
